...
//  GET (requisição) - "lê" todos os usuarios
app.get('/api', (req, res) => {
  let users = getUsers()
...
//  GET (requisição) - "lê" os usuarios (cpf)
...
//  POST (requisição) - Adiciona  usuario
...
//  PUT (requisição) - Altera dados do usuário
...
// DELETE (requisição) - Deleta o usuário
